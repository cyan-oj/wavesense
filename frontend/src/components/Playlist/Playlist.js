...
const Playlist = ({ songUrl, setSongUrl }) => {
    ...
    const handleDelete = (e) => {
        ...
        // console.log(currentUser._id,e.target.id)
        if(currentUser){
            if(currentUser._id===e.target.id){
                ...
                return alert('You Must Be The Uploader');
            }
        } else {
        ...
        return (
                <li key={i} className={styles.songListItems}>
                    <div className={styles.playPauseAndButton}>
                        ...
                        <div className={styles.addDelete} value={song} id={song._id} onClick={handleDelete}>
